        ...
        <div class="row">
            <div class="col-6">
                ...
                <div class="mb-3 text-start">
                    ...
                    <input type="text" name="txtStatus" class="form-control" disabled value="ACTIVA">
                    @else
                    <input type="text" name="txtStatus" class="form-control" disabled value="INACTIVA">
                    @endif
                </div>
            </div>
            <div class="col-6">
                ...
                <form action="/dashboard/mp/edit" method="PUT">
                    <h1>Anda a saber....</h1>
                </form>
            </div>
        </div>
